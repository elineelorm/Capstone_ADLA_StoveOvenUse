"""
    testdataWithId.py
    This file includes the testdataWithId model.
...
class TestDataWithId:
    ''' 
    An instance of TestDataWithId represents dataset that is sampled from a thermal video created in 2023.
    TestDataWithId records are stored in an analysis table pertaining to the specific thermal video file.
    
    Each instance of TestDataWithId contains the following fields:
        id (INTEGER) - Not in the model but autoincrement as the dataset being inserted (auto incremented primary key)
        stoveId (INETEGER) - The Id of the stove
    ...
    '''
    def __init__(self, stoveId, state, type, safety, time_elapsed_1, avg_pan_temp_1, highest_pan_temp_1, lowest_pan_temp_1, avg_food_temp_1, highest_food_temp_1, lowest_food_temp_1, 
    ...
    def get_as_record(self):
        return (self.stoveId, self.state, self.type, self.safety, 
